...
export const ProductsListPage = () => {
    ...
    return (
        <div className="bg-accent w-full">
            {/* Banner Section */}
            <div className="w-full h-[300px] sm:h-[400px] lg:h-screen flex justify-center items-center bg-accent overflow-hidden">
                <Image
                    alt="Card background"
            ...
            <div className="bg-accent w-full py-6 px-2 grid grid-cols-2 gap-2 sm:gap-4 md:grid-cols-2 lg:grid-cols-4">
                {productData.slice(0, 4).map(product => (
                    <Card
                        className="md:min-w-[270px] flex flex-col h-[450px] transition-all duration-300 border border-transparent hover:border-black hover:shadow-lg cursor-pointer"
                        key={product.model}
                        shadow="sm"
                        radius="sm"
                    >
